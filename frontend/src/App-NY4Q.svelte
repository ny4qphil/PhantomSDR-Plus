...
<button id="vfo-ab-button" class="glass-button text-white font-bold py-2 px-4 rounded-lg flex items-center w-full justify-center {toggleVFO === vfo ? 'bg-green-600 pressed scale-95' : 'bg-blue-700 hover:bg-gray-600'}" on:click={() => toggleVFO(vfo)} title="VFO Toggle">
