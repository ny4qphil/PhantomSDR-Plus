  ...
  function verifyRegion(region) {
	...
	break;
     case 1:
       ...
       console.log("r = " + region + ", sR = " + siteRegion); 
       break;
     case 2:
...
<div class="w-full mt-4">
  <div class="grid grid-cols-1 sm:grid-cols-9 gap-2">
    {#each newBandwidth as newbandwidth}
      <button id="fine-tuning-selector" class="retro-button text-sm text-white font-bold h-10 text-base rounded-md flex items-center justify-center border border-gray-600 shadow-inner transition-all duration-200 ease-in-out bg-gray-700 hover:bg-gray-600" on:click={() => handleBandwidthChange(newbandwidth)} title="{newbandwidth}">
