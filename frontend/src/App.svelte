...
let bandwidth;
  ...
  function verifyRegion(region) {
    ...
    let ITU = region.toString();
    if ((ITU.indexOf('1') > -1) && (siteRegion == 1)) { return true; }
      else if ((ITU.indexOf('2') > -1) && (siteRegion == 2)) { return true; }
      else if ((ITU.indexOf('3') > -1) && (siteRegion == 3)) { return true; }
      else { return false; }
  }
